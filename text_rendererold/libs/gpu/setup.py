...
#opencv_libs_str = subprocess.check_output("pkg-config --libs opencv".split()).decode('utf-8')
#opencv_incs_str = subprocess.check_output("pkg-config --cflags opencv".split()).decode('utf-8')
opencv_libs_str=r'C:\Users\October/anaconda3\envs\label\Lib\site-packages\cv2'
opencv_incs_str = r"C:\Users\October\anaconda3\envs\label\include"
